...
class ArchInstall:
    ...
    def partitioning(self):
        ...
        print(f"{GREEN}[DISK]{RESET}: Formatting the partitions...")
    ...
    def mount_filesystems(self):
        print(f"{GREEN}[DISK]{RESET}: Mounting the partitions...")
    ...
    def system_settings(self):
        ...
        print(f"{GREEN}[CHROOT]{RESET}: Chroot...")
